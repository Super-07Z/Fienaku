...
insert into user (name, lastname, job, floor, phone, mail, account, userType, username, password, create_At) values ('Javier', 'Inca', 'Pasante', '23', '123426', 'javier.inca@bancofie.com.bo', 153248, 'ROLE_MANAGER', 'Encargado 2', '$2a$10$mfIRU2sow.VMXSSrOxuM2uzIEEi9ignZ1oUPzfsh5MS.PyeerVPIm', NOW());
